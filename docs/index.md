...
Commission fee - 0.3% from total amount, but no more than 0.50 EUR.
...
Commission fee - 3.0% from amount, but not less than 5.00 EUR for operation.
...
When converting currencies, following conversion rates are applied: `EUR:USD` - `1:1.1297`, `EUR:JPY` - `1:119.51`
